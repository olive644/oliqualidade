...
export const PRODUCT_UPDATES: ProductUpdate[] = [
  {
    ...
    date: "2026-08-30",
    title: "A tela para de descer, os gráficos desenham mais rápido e inspecionar ficou leve",
    summary:
    ...
    highlights: [
      ...
      "Passar o mouse por cima de um gráfico para inspecionar também ficou muito mais leve. O destaque agora acompanha onde o ponteiro para, e não cada barra que ele atravessa no caminho. Medido num gráfico de 25 barras: o tempo em que o navegador ficava ocupado caiu de 2.883 para cerca de 700 milissegundos.",
    ],
  },
  {
